...
// limitations under the License.
  ...
  /// operation.
  ///
  /// [google.cloud.dialogflow.v2.ConversationModels.UndeployConversationModel]: <doc:ConversationModels/undeployConversationModel(request:)>
  public struct UndeployConversationModelOperationMetadata: Codable, Equatable, GoogleCloudWkt
      ._AnyPackable,
    Sendable
  {
