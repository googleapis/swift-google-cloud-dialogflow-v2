...
// limitations under the License.
  ...
  extension Clients {
    class FulfillmentsTransport: FulfillmentsStub {
      ...
      public func getFulfillment(
        ...
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudDialogflowV2.Fulfillment.self, from: data)
      }
      ...
      public func updateFulfillment(
        ...
        let path = try { () throws -> Swift.String in
          guard let pathVariable0 = request.fulfillment.map({ $0.name }), !pathVariable0.isEmpty
          else {
            throw GoogleCloudGax.RequestError.binding(
              "'request.fulfillment.name' is not set or is empty")
          }
          return "/v2/\(pathVariable0)"
        }()
        var query = [
