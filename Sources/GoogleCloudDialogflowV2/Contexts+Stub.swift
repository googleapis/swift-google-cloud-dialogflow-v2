...
// limitations under the License.
  ...
  extension Clients {
    ...
    class ContextsTransport: ContextsStub {
      ...
      public func listContexts(
        ...
        let path = try { () throws -> Swift.String in
          ...
          return "/v2/\(pathVariable0)/contexts"
        }()
        var query = [
        ...
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudDialogflowV2.ListContextsResponse.self, from: data)
      }
      ...
      public func getContext(
        ...
        let (data, _) = try await self.inner.rpc(for: req).get()
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudDialogflowV2.Context.self, from: data)
      }
