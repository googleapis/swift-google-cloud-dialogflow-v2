...
// limitations under the License.
  ...
  extension Clients {
    final class FulfillmentsRetry: FulfillmentsStub {
      let inner: any FulfillmentsStub
      let options: GoogleCloudGax.ClientOptions

      public init(_ inner: any FulfillmentsStub, options: GoogleCloudGax.ClientOptions) {
        self.inner = inner
      ...
      public func getFulfillment(
        ...
        try await self._intercept(
          ...
          idempotent: true,
          action: {
            (r: GetFulfillmentRequest, o: GoogleCloudGax.RequestOptions) async throws
              -> GoogleCloudDialogflowV2.Fulfillment
            in
            return try await self.inner.getFulfillment(request: r, options: o)
          })
      }
      ...
      public func updateFulfillment(
        ...
        try await self._intercept(
          ...
          idempotent: false,
          action: {
            (r: UpdateFulfillmentRequest, o: GoogleCloudGax.RequestOptions) async throws
              -> GoogleCloudDialogflowV2.Fulfillment
            in
            return try await self.inner.updateFulfillment(request: r, options: o)
          })
      }
