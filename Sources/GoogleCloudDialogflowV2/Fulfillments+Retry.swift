...
// limitations under the License.
  ...
  extension Clients {
    final class FulfillmentsRetry: FulfillmentsStub {
      ...
      public init(_ inner: any FulfillmentsStub, options: GoogleGax.ClientOptions) {
        self.inner = inner
      ...
      public func getFulfillment(
        ...
        try await self._intercept(
          ...
          idempotent: true,
          action: {
            (r: GetFulfillmentRequest, o: GoogleGax.RequestOptions) async throws
      ...
      public func updateFulfillment(
        ...
        try await self._intercept(
          ...
          idempotent: false,
          action: {
            (r: UpdateFulfillmentRequest, o: GoogleGax.RequestOptions) async throws
              -> GoogleCloudDialogflowV2.Fulfillment
            in
