...
// limitations under the License.
  ...
  extension Clients {
    ...
    class ConversationModelsTransport: ConversationModelsStub {
      ...
      public func createConversationModel(
        ...
        let path = try { () throws -> Swift.String in
          ...
          return "/v2/\(pathVariable0)/conversationModels"
        }()
        let query = [
      ...
      public func getConversationModel(
        ...
        let (data, _) = try await self.inner.rpc(for: req).get()
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudDialogflowV2.ConversationModel.self, from: data)
      }
      ...
      public func listConversationModels(
        ...
        let (data, _) = try await self.inner.rpc(for: req).get()
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudDialogflowV2.ListConversationModelsResponse.self, from: data)
      }
      ...
      public func deployConversationModel(
        ...
        let path = try { () throws -> Swift.String in
          ...
          return "/v2/\(pathVariable0):deploy"
        }()
        let query = [
          URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
        ]
      ...
      public func undeployConversationModel(
        ...
        let path = try { () throws -> Swift.String in
          ...
          return "/v2/\(pathVariable0):undeploy"
        }()
        let query = [
          URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
        ]
      ...
      public func getConversationModelEvaluation(
        ...
        let (data, _) = try await self.inner.rpc(for: req).get()
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudDialogflowV2.ConversationModelEvaluation.self, from: data)
      }
      ...
      public func listConversationModelEvaluations(
        ...
        let (data, _) = try await self.inner.rpc(for: req).get()
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudDialogflowV2.ListConversationModelEvaluationsResponse.self, from: data)
      }
