...
// limitations under the License.
  ...
  extension Clients {
    ...
    class SipTrunksTransport: SipTrunksStub {
      ...
      public func createSipTrunk(
        ...
        let path = try { () throws -> Swift.String in
          ...
          return "/v2/\(pathVariable0)/sipTrunks"
        }()
        let query = [
        ...
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudDialogflowV2.SipTrunk.self, from: data)
      }
      ...
      public func listSipTrunks(
        ...
        let (data, _) = try await self.inner.rpc(for: req).get()
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudDialogflowV2.ListSipTrunksResponse.self, from: data)
      }
      ...
      public func updateSipTrunk(
        ...
        let path = try { () throws -> Swift.String in
          guard let pathVariable0 = request.sipTrunk.map({ $0.name }), !pathVariable0.isEmpty else {
            throw GoogleCloudGax.RequestError.binding(
              "'request.sip_trunk.name' is not set or is empty")
          }
          return "/v2/\(pathVariable0)"
        }()
        var query = [
