...
// limitations under the License.
  ...
  extension Clients {
    ...
    class DocumentsTransport: DocumentsStub {
      ...
      public func listDocuments(
        ...
        let path = try { () throws -> Swift.String in
          ...
          return "/v2/\(pathVariable0)/documents"
        }()
        var query = [
        ...
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudDialogflowV2.ListDocumentsResponse.self, from: data)
      }
      ...
      public func getDocument(
        ...
        let (data, _) = try await self.inner.rpc(for: req).get()
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudDialogflowV2.Document.self, from: data)
      }
      ...
      public func importDocuments(
        ...
        let path = try { () throws -> Swift.String in
          ...
          return "/v2/\(pathVariable0)/documents:import"
        }()
        let query = [
          URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
        ]
      ...
      public func reloadDocument(
        ...
        let path = try { () throws -> Swift.String in
          ...
          return "/v2/\(pathVariable0):reload"
        }()
        let query = [
          URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
        ]
      ...
      public func exportDocument(
        ...
        let path = try { () throws -> Swift.String in
          ...
          return "/v2/\(pathVariable0):export"
        }()
        let query = [
          URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
        ]
