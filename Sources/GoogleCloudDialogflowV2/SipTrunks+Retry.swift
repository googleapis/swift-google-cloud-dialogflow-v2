...
// limitations under the License.
  ...
  extension Clients {
    final class SipTrunksRetry: SipTrunksStub {
      ...
      public init(_ inner: any SipTrunksStub, options: GoogleGax.ClientOptions) {
        self.inner = inner
      ...
      public func createSipTrunk(
        ...
        try await self._intercept(
          ...
          idempotent: false,
          action: {
            (r: CreateSipTrunkRequest, o: GoogleGax.RequestOptions) async throws
      ...
      public func deleteSipTrunk(
        ...
        try await self._intercept(
          ...
          options: options,
          idempotent: false,
          action: { (r: DeleteSipTrunkRequest, o: GoogleGax.RequestOptions) async throws -> Void in
      ...
      public func listSipTrunks(
        ...
        try await self._intercept(
          ...
          idempotent: true,
          action: {
            (r: ListSipTrunksRequest, o: GoogleGax.RequestOptions) async throws
      ...
      public func getSipTrunk(
        ...
        try await self._intercept(
          ...
          idempotent: true,
          action: {
            (r: GetSipTrunkRequest, o: GoogleGax.RequestOptions) async throws
              -> GoogleCloudDialogflowV2.SipTrunk
            in
      ...
      public func updateSipTrunk(
        ...
        try await self._intercept(
          ...
          idempotent: false,
          action: {
            (r: UpdateSipTrunkRequest, o: GoogleGax.RequestOptions) async throws
              -> GoogleCloudDialogflowV2.SipTrunk
            in
