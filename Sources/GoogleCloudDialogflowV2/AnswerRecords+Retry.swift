...
// limitations under the License.
  ...
  extension Clients {
    final class AnswerRecordsRetry: AnswerRecordsStub {
      ...
      public init(_ inner: any AnswerRecordsStub, options: GoogleGax.ClientOptions) {
        self.inner = inner
      ...
      public func listAnswerRecords(
        ...
        try await self._intercept(
          ...
          idempotent: true,
          action: {
            (r: ListAnswerRecordsRequest, o: GoogleGax.RequestOptions) async throws
      ...
      public func updateAnswerRecord(
        ...
        try await self._intercept(
          ...
          idempotent: false,
          action: {
            (r: UpdateAnswerRecordRequest, o: GoogleGax.RequestOptions) async throws
