...
// limitations under the License.
  ...
  public class EnvironmentsClient: Clients.EnvironmentsProtocol {
    ...
    public func listEnvironments(
      ...
      let listRpc = {
        (token: String) async throws -> GoogleCloudDialogflowV2.ListEnvironmentsResponse in
        var request = byItem
    ...
    public func getEnvironmentHistory(
      ...
      let listRpc = { (token: String) async throws -> GoogleCloudDialogflowV2.EnvironmentHistory in
        var request = byItem
        request.pageToken = token
