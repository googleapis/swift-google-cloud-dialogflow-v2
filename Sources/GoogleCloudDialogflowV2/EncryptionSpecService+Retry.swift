...
// limitations under the License.
  ...
  extension Clients {
    final class EncryptionSpecServiceRetry: EncryptionSpecServiceStub {
      let inner: any EncryptionSpecServiceStub
      let options: GoogleCloudGax.ClientOptions

      public init(_ inner: any EncryptionSpecServiceStub, options: GoogleCloudGax.ClientOptions) {
        self.inner = inner
