...
// limitations under the License.
  ...
  extension Clients {
    ...
    class AnswerRecordsTransport: AnswerRecordsStub {
      ...
      public func listAnswerRecords(
        ...
        let path = try { () throws -> Swift.String in
          ...
          return "/v2/\(pathVariable0)/answerRecords"
        }()
        var query = [
        ...
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudDialogflowV2.ListAnswerRecordsResponse.self, from: data)
      }
      ...
      public func updateAnswerRecord(
        ...
        let path = try { () throws -> Swift.String in
          guard let pathVariable0 = request.answerRecord.map({ $0.name }), !pathVariable0.isEmpty
          else {
            throw GoogleCloudGax.RequestError.binding(
              "'request.answer_record.name' is not set or is empty")
          }
        ...
        let (data, _) = try await self.inner.rpc(for: req).get()
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudDialogflowV2.AnswerRecord.self, from: data)
      }
