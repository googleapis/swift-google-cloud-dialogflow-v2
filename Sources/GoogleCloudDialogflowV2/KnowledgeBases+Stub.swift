...
// limitations under the License.
  ...
  extension Clients {
    ...
    class KnowledgeBasesTransport: KnowledgeBasesStub {
      ...
      public func listKnowledgeBases(
        ...
        let path = try { () throws -> Swift.String in
          ...
          return "/v2/\(pathVariable0)/knowledgeBases"
        }()
        var query = [
        ...
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudDialogflowV2.ListKnowledgeBasesResponse.self, from: data)
      }
      ...
      public func getKnowledgeBase(
        ...
        let (data, _) = try await self.inner.rpc(for: req).get()
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudDialogflowV2.KnowledgeBase.self, from: data)
      }
      ...
      public func updateKnowledgeBase(
        ...
        let path = try { () throws -> Swift.String in
          guard let pathVariable0 = request.knowledgeBase.map({ $0.name }), !pathVariable0.isEmpty
          else {
            throw GoogleCloudGax.RequestError.binding(
              "'request.knowledge_base.name' is not set or is empty")
          }
          return "/v2/\(pathVariable0)"
        }()
        var query = [
