...
// limitations under the License.
  ...
  extension Clients {
    protocol EncryptionSpecServiceStub {
    ...
    class EncryptionSpecServiceTransport: EncryptionSpecServiceStub {
      ...
      public func getEncryptionSpec(
        ...
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudDialogflowV2.EncryptionSpec.self, from: data)
      }
      ...
      public func initializeEncryptionSpec(
        ...
        let path = try { () throws -> Swift.String in
          ...
          return "/v2/\(pathVariable0):initialize"
        }()
        let query = [
          URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
        ]
