...
// limitations under the License.
  ...
  extension Clients {
    ...
    class GeneratorEvaluationsTransport: GeneratorEvaluationsStub {
      ...
      public func createGeneratorEvaluation(
        ...
        let path = try { () throws -> Swift.String in
          ...
          return "/v2/\(pathVariable0)/evaluations"
        }()
        let query = [
      ...
      public func getGeneratorEvaluation(
        ...
        let (data, _) = try await self.inner.rpc(for: req).get()
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudDialogflowV2.GeneratorEvaluation.self, from: data)
      }
      ...
      public func listGeneratorEvaluations(
        ...
        let (data, _) = try await self.inner.rpc(for: req).get()
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudDialogflowV2.ListGeneratorEvaluationsResponse.self, from: data)
      }
