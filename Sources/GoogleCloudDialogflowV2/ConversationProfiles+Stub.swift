...
// limitations under the License.
  ...
  extension Clients {
    protocol ConversationProfilesStub {
    ...
    class ConversationProfilesTransport: ConversationProfilesStub {
      ...
      public func listConversationProfiles(
        ...
        let path = try { () throws -> Swift.String in
          ...
          return "/v2/\(pathVariable0)/conversationProfiles"
        }()
        var query = [
        ...
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudDialogflowV2.ListConversationProfilesResponse.self, from: data)
      }
      ...
      public func getConversationProfile(
        ...
        let (data, _) = try await self.inner.rpc(for: req).get()
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudDialogflowV2.ConversationProfile.self, from: data)
      }
      ...
      public func updateConversationProfile(
        ...
        let path = try { () throws -> Swift.String in
          guard let pathVariable0 = request.conversationProfile.map({ $0.name }),
            !pathVariable0.isEmpty
          else {
            throw GoogleCloudGax.RequestError.binding(
              "'request.conversation_profile.name' is not set or is empty")
          }
          return "/v2/\(pathVariable0)"
        }()
        var query = [
      ...
      public func setSuggestionFeatureConfig(
        ...
        let path = try { () throws -> Swift.String in
          guard let pathVariable0 = request.conversationProfile as Swift.String?,
            !pathVariable0.isEmpty
          else {
            throw GoogleCloudGax.RequestError.binding(
              "'request.conversation_profile' is not set or is empty")
          }
          return "/v2/\(pathVariable0):setSuggestionFeatureConfig"
        }()
        let query = [
          URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
        ]
      ...
      public func clearSuggestionFeatureConfig(
        ...
        let path = try { () throws -> Swift.String in
          ...
          return "/v2/\(pathVariable0):clearSuggestionFeatureConfig"
        }()
        let query = [
          URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
        ]
