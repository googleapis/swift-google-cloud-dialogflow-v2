    ...
    class IntentsTransport: IntentsStub {
      ...
      public func listIntents(
        ...
        let path = try { () throws -> Swift.String in
          ...
          return "/v2/\(pathVariable0)/intents"
        }()
        var query = [
        ...
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudDialogflowV2.ListIntentsResponse.self, from: data)
      }
      ...
      public func getIntent(
        ...
        let (data, _) = try await self.inner.rpc(for: req).get()
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudDialogflowV2.Intent.self, from: data)
      }
      ...
      public func batchUpdateIntents(
        ...
        let path = try { () throws -> Swift.String in
          ...
          return "/v2/\(pathVariable0)/intents:batchUpdate"
        }()
        let query = [
          URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
        ]
      ...
      public func batchDeleteIntents(
        ...
        let path = try { () throws -> Swift.String in
          ...
          return "/v2/\(pathVariable0)/intents:batchDelete"
        }()
        let query = [
          URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
        ]
