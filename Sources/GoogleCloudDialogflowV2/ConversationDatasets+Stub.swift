    ...
    class ConversationDatasetsTransport: ConversationDatasetsStub {
      ...
      public func createConversationDataset(
        ...
        let path = try { () throws -> Swift.String in
          ...
          return "/v2/\(pathVariable0)/conversationDatasets"
        }()
        let query = [
      ...
      public func getConversationDataset(
        ...
        let (data, _) = try await self.inner.rpc(for: req).get()
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudDialogflowV2.ConversationDataset.self, from: data)
      }
      ...
      public func listConversationDatasets(
        ...
        let (data, _) = try await self.inner.rpc(for: req).get()
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudDialogflowV2.ListConversationDatasetsResponse.self, from: data)
      }
      ...
      public func importConversationData(
        ...
        let path = try { () throws -> Swift.String in
          ...
          return "/v2/\(pathVariable0):importConversationData"
        }()
        let query = [
          URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
        ]
